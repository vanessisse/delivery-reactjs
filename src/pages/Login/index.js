        ...
        <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center'>
          ...
          <div className="grid grid-cols-1 w-1/5">
            <div className='flex flex-col mt-5 mb-5'>
              ...
              <input type='mail' placeholder="Digite seu e-mail" name="email" className='border custom-border-color p-2 rounded-full focus:ring-1 focus:outline-none transition duration-300 focus:shadow-xl' onChange={handleChangeValues} />
            </div>
            <div className='flex flex-col mb-5'>
              <label htmlFor='senha' className='text-primary text-md font-bold'>Senha:</label>
              <input type='password' placeholder="Digite sua senha" name="senha" className='border custom-border-color p-2 rounded-full focus:ring-1 focus:outline-none transition duration-300 focus:shadow-xl' onChange={handleChangeValues}/>
            </div>
          </div>
